...
`);
  ...
  function tweet() {
    window.open(
      `https://twitter.com/intent/tweet?text=${createSellText(
        sellItem.name,
        sellItem.contract
      )}`,
      "_blank"
  ...
  function tweet2() {
    window.open(
      `https://twitter.com/intent/tweet?text=${createPurchaseText(
        buyItem.name,
        buyItem.contract
      )}`,
      "_blank"
...
<Modal open={confirmSaleDialog} ok={false}>
  ...
  <div>
    ...
    <div class="flex justify-end">
      <a
        on:click|preventDefault={tweet}
        href="#"
        class="btn btn-outline rounded-none btn-info"
      >
        <svg
          width="16px"
          height="16px"
...
<Modal open={confirmPurchaseDialog} ok={false}>
  ...
  <div>
    ...
    <div class="flex justify-end">
      <a
        on:click|preventDefault={tweet2}
        href="#"
        class="btn btn-outline rounded-none btn-info"
      >
        <svg
